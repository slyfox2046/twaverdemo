...
$(function(){$(".o-tab .o-tab-hd > li").on("click",function(){if($(this).hasClass("disabled"))return!1;$(this).addClass("active").siblings().removeClass("active");var a=$(this).index();$(this).parent().next().find(".o-tab-content > li").eq(a).show().siblings().hide()}),$(".o-panel-hd .o-tab > li").on("click",function(){$(this).addClass("active").siblings().removeClass("active");var a=$(this).index();$(this).parent().parent().next().find(".o-panel-content > li").eq(a).show().siblings().hide()}),$(".o-panel-hd .arrow-box").on("click",function(){$(this).find(".arrow").hasClass("arrow-down")?($(this).find(".arrow").removeClass("arrow-down").addClass("arrow-up"),$(this).parent().parent(".o-panel-hd").next().hide()):($(this).find(".arrow").removeClass("arrow-up").addClass("arrow-down"),$(this).parent().parent(".o-panel-hd").next().show())}),$(".o-panel-hd .close").on("click",function(){$(this).parent().parent().parent().hide()}),$(".o-upload .viewfile").mouseout(function(){$(this).parent().siblings(".upload").hide()}),$(".o-upload .file1").mouseover(function(){$(this).siblings(".upload").show()}),$(".o-upload .file").change(function(){$(this).siblings(".span").find(".viewfile").val($(this).val()),$(this).hide()}),$(".input-search-multiple .input-search .arrow-box").on("click",function(){var a=$(this).parent().parent().next(".input-search-bd").height()+10;Math.ceil(a/32),$(".o-table-rows").height();$(this).find(".arrow").hasClass("arrow-down")?$(this).find(".arrow").removeClass("arrow-down").addClass("arrow-up"):$(this).find(".arrow").removeClass("arrow-up").addClass("arrow-down"),$(this).toggleClass("show-bd"),$(this).parent().parent().next(".input-search-bd").toggleClass("o-hide")}),function(a,s){var o=s;$(a).on("input propertychange",function(){var a=$(this),s=$(".word-count"),e=a.val().length;if(e>=o){var r=a.val().substr(0,o-1);a.val(r),s.text(o+"/"+o)}else s.text(e+"/"+o)})}(".o-textarea .textarea",200),$(".o-nav-select .select-content > li").on("click",function(){$(this).addClass("active").siblings().removeClass("active")}),$(".o-menu ").on("click",".second-menu-hd .arrow-box",function(){$(this).find(".arrow").hasClass("arrow-down")?($(this).parents(".o-menu-bd").find(".second-menu-hd .arrow").removeClass("arrow-up").addClass("arrow-down"),$(this).parents(".o-menu-bd").find(".second-menu-bd").slideUp(),$(this).find(".arrow").removeClass("arrow-down").addClass("arrow-up"),$(this).parent().next().slideDown()):($(this).find(".arrow").removeClass("arrow-up").addClass("arrow-down"),$(this).parent().next().slideUp())}),$(".o-menu").on("click",".second-menu-bd .arrow-box",function(){$(this).find(".arrow").hasClass("arrow-down")?($(this).find(".arrow").removeClass("arrow-down").addClass("arrow-up"),$(this).siblings(".third-menu").removeClass("o-hide")):($(this).find(".arrow").removeClass("arrow-up").addClass("arrow-down"),$(this).siblings(".third-menu").addClass("o-hide"))}),$(".o-area .o-select-area").on("click",function(){$(this).find(".arrow").hasClass("arrow-down")?($(this).find(".arrow").removeClass("arrow-down").addClass("arrow-up"),$(this).parent().find(".o-tab").show()):($(this).find(".arrow").removeClass("arrow-up").addClass("arrow-down"),$(this).parent().find(".o-tab").hide())}),$("body").click(function(a){"BODY"!=a.target.tagName&&"DIV"!=a.target.tagName&&"SELECT"!=a.target.tagName&&"INPUT"!=a.target.tagName&&"TEXTAREA"!=a.target.tagName||"o-select-area"!=a.target.className&&($(".o-area.o-area-suspend .o-tab").fadeOut("fast"),$(".o-area.o-area-suspend .o-select-area").find(".arrow").removeClass("arrow-up").addClass("arrow-down"))})});
!function(e){function t(){}t.prototype={systemTitle:"系统提示",systemAlert:function(e,t){if(t&&1*t==1)try{parent.layer.alert(e,{title:this.systemTitle,btnAlign:"c"})}catch(t){layer.alert(e,{title:this.systemTitle,btnAlign:"c"})}else if(t&&1*t==2)try{top.layer.alert(e,{title:this.systemTitle,btnAlign:"c"})}catch(t){layer.alert(e,{title:this.systemTitle,btnAlign:"c"})}else layer.alert(e,{title:this.systemTitle,btnAlign:"c"})},errorOperateAlert:function(e){var t="操作异常，请联系管理员";if(e&&1*e==1)try{parent.layer.alert(t,{title:this.systemTitle,btnAlign:"c"})}catch(e){layer.alert(t,{title:this.systemTitle,btnAlign:"c"})}else if(e&&1*e==2)try{top.layer.alert(t,{title:this.systemTitle,btnAlign:"c"})}catch(e){layer.alert(t,{title:this.systemTitle,btnAlign:"c"})}else layer.alert(t,{title:this.systemTitle,btnAlign:"c"})},onMsg:function(e,t){if(t&&1*t==1)try{parent.layer.msg(e,{shadeClose:!0,time:0,shade:.001})}catch(t){layer.msg(e,{shadeClose:!0,time:0,shade:.001})}else if(t&&1*t==2)try{top.layer.msg(e,{shadeClose:!0,time:0,shade:.001})}catch(t){layer.msg(e,{shadeClose:!0,time:0,shade:.001})}else layer.msg(e,{shadeClose:!0,time:0,shade:.001})},errorRequestAlert:function(e){if(e&&1*e==1)try{parent.layer.alert("请求异常",{title:this.systemTitle,btnAlign:"c"})}catch(e){layer.alert("请求异常",{title:this.systemTitle,btnAlign:"c"})}else if(e&&1*e==2)try{top.layer.alert("请求异常",{title:this.systemTitle,btnAlign:"c"})}catch(e){layer.alert("请求异常",{title:this.systemTitle,btnAlign:"c"})}else layer.alert("请求异常",{title:this.systemTitle,btnAlign:"c"})},noSearchMessage:function(e){if(e&&1*e==1)try{parent.layer.msg("查无数据",{shadeClose:!0,time:0,shade:.001})}catch(e){layer.msg("查无数据",{shadeClose:!0,time:0,shade:.001})}else if(e&&1*e==2)try{top.layer.msg("查无数据",{shadeClose:!0,time:0,shade:.001})}catch(e){layer.msg("查无数据",{shadeClose:!0,time:0,shade:.001})}else layer.msg("查无数据",{shadeClose:!0,time:0,shade:.001})},shadeMessage:function(e,t){if(t&&1*t==1)try{parent.layer.msg(e,{shadeClose:!0,time:0,shade:.001})}catch(t){layer.msg(e,{shadeClose:!0,time:0,shade:.001})}else if(t&&1*t==2)try{top.layer.msg(e,{shadeClose:!0,time:0,shade:.001})}catch(t){layer.msg(e,{shadeClose:!0,time:0,shade:.001})}else layer.msg(e,{shadeClose:!0,time:0,shade:.001})},load:function(e){if(e&&1*e==1)try{return parent.layer.load()}catch(e){return layer.load()}else{if(!e||1*e!=2)return layer.load();try{return top.layer.load()}catch(e){return layer.load()}}},close:function(e,t){if(t&&1*t==1)try{parent.layer.close(e)}catch(t){layer.close(e)}else if(t&&1*t==2)try{top.layer.close(e)}catch(t){layer.close(e)}else layer.close(e)},closeAll:function(e,t){if(t&&1*t==1)if(e)try{parent.layer.closeAll(e)}catch(t){layer.closeAll(e)}else try{parent.layer.closeAll()}catch(e){layer.closeAll()}else if(t&&1*t==2)if(e)try{top.layer.closeAll(e)}catch(t){layer.closeAll(e)}else try{top.layer.closeAll()}catch(e){layer.closeAll()}else e?layer.closeAll(e):layer.closeAll()},errorInfo:function(e,t){window.parent.$("body").scope().setErrorInfo(e)}},e.oss_layer=new t}(window);